...
%     F1 = parfeval(@BSeuCall2Dbasket_RBFFDreg_phs,8,N(ii),p,d,nm,M(ii),Kmul);
    F3 = parfeval(@BSeuCall2Dbasket_RBFFDreg_smooth_phs,8,N(ii),p,d,nm,M(ii),Kmul);
%     F5 = parfeval(@BSeuCall2Dbasket_RBFFDadap_phs,8,N(ii),g,p,d,nm,M(ii),Kmul);
    F7 = parfeval(@BSeuCall2Dbasket_RBFFDreg_smooth_phs_dev,8,N(ii),p,d,nm,M(ii),Kmul);
    
    d = 5;
    p = 7;
%     F2 = parfeval(@BSeuCall2Dbasket_RBFFDreg_phs,8,N(ii),p,d,nm,M(ii),Kmul);
    F4 = parfeval(@BSeuCall2Dbasket_RBFFDreg_smooth_phs,8,N(ii),p,d,nm,M(ii),Kmul);
%     F6 = parfeval(@BSeuCall2Dbasket_RBFFDadap_phs,8,N(ii),g,p,d,nm,M(ii),Kmul);
    F8 = parfeval(@BSeuCall2Dbasket_RBFFDreg_smooth_phs_dev,8,N(ii),p,d,nm,M(ii),Kmul);
...
%         'PHSd3p5\_reg_smooth_phs_hloc',... %F7
%         'PHSd5p7\_reg_smooth_phs_hloc'); %F8
