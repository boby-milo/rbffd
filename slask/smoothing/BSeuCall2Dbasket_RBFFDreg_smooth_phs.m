function [u,err,tim,x,dx,n,N,W] = BSeuCall2Dbasket_RBFFDreg_smooth_phs(Nx,p,d,nm,M,Kmul)
%% 2D EU Call RBF-FD with BDF2

funname = 'BSeuCall2Dbasket_RBFFDreg_smooth_phs';
...
if ~isempty(names)
    ...
    xvecind = xvec(indreg);
    yvecind = yvec(indreg);
    uind = smooth4([xvecind', yvecind'],fu,dx,2);
