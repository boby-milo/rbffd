...
for ii = 1:numel(N)
    ...
    F3 = parfeval(@BSeuCall2Dbasket_RBFFDadap_phs,8,N(ii),p,d,M(ii),Kmul,g);
    ...
    F4 = parfeval(@BSeuCall2Dbasket_RBFFDadap_phs,8,N(ii),p,d,M(ii),Kmul,g);
