...
%% FD
filepaths=getfilenames(path,'BSamPutbasket2D_FD*.mat');
N=length(filepaths);
for ii=1:N
    load(filepaths{ii})
...
%% RBF-FD adap
% n=9
filepaths=getfilenames(path,'BSamPutbasket2D_RBFFDadapEpsmin_ep9*.mat');
N=length(filepaths);
for ii=1:N
    load(filepaths{ii})
...
% n=13
filepaths=getfilenames(path,'BSamPutbasket2D_RBFFDadapEpsmin_ep13*.mat');
N=length(filepaths);
for ii=1:N
    load(filepaths{ii})
...
% n=25
filepaths=getfilenames(path,'BSamPutbasket2D_RBFFDadapEpsmin_ep25*.mat');
N=length(filepaths);
for ii=1:N
    load(filepaths{ii})
...
%% RBF-FD reg
% n=9
filepaths=getfilenames(path,'BSamPutbasket2D_RBFFDreg_ep9*.mat');
N=length(filepaths);
for ii=1:N
    load(filepaths{ii})
...
% n=13
filepaths=getfilenames(path,'BSamPutbasket2D_RBFFDreg_ep13*.mat');
N=length(filepaths);
for ii=1:N
    load(filepaths{ii})
...
% n=25
filepaths=getfilenames(path,'BSamPutbasket2D_RBFFDreg_ep25*.mat');
N=length(filepaths);
for ii=1:N
    load(filepaths{ii})
