...
%% RBF-FD adap
% n=9
filepaths=getfilenames(path,'BSeuCallbasket2D_RBFFDadapEps_ep9*.mat');
N=length(filepaths);
for ii=1:N
    load(filepaths{ii})
...
% n=13
filepaths=getfilenames(path,'BSeuCallbasket2D_RBFFDadapEps_ep13*.mat');
N=length(filepaths);
for ii=1:N
    load(filepaths{ii})
...
% n=25
filepaths=getfilenames(path,'BSeuCallbasket2D_RBFFDadapEps_ep25*.mat');
N=length(filepaths);
for ii=1:N
    load(filepaths{ii})
