function [u,err,tim,x,dx,n,N,W] = BSamPut2Dbasket_RBFFDreg_smoothed_phs(Nx,p,d,nm,M,Kmul)
%% 2D EU Call RBF-FD with BDF2

funname = 'BSamPut2Dbasket_RBFFDreg_smoothed_phs';
