function [u,err,tim,x,dx,n,N,W] = BSeuCall2Dbasket_RBFFDrepel_smoothed_phs(Nx,p,d,nm,M,Kmul)
% if nargin == 1
%     pl = 0;
% end
%% Check if this parameter combination is already computed and if it is just load the result, else compute.
funname = 'BSeuCall2Dbasket_RBFFDrepel_smoothed_phs';
