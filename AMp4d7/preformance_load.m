...
legend('fd2','gs reg','gs adap','phs reg','phs adap','phs reg smoothed','phs adap smoothed','Location','NW')

% legend('gs reg','gs adap','phs reg','phs adap','phs reg smoothed','phs adap smoothed','Location','NW')
