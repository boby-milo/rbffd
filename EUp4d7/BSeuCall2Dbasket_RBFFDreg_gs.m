function [u,err,tim,x,dx,ep,N,W] = BSeuCall2Dbasket_RBFFDreg_gs(Nx,n,M,Kmul)
%% 2D EU Call RBF-FD with BDF2

funname = 'BSeuCall2Dbasket_RBFFDreg_gs';
datafilename = [funname,'___Nx',num2str(Nx),'_n',num2str(n),'_M',num2str(M),'_Kmul',num2str(Kmul),'.mat'];
...
%     % pause()
    ...
    cd('./Data')
    save(datafilename, 'u', 'err', 'tim', 'x', 'dx','ep','N','W','Nx','n','M','Kmul')
    cd('..')
